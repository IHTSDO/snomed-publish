...
public class MetaSnomedSerialiser extends BaseSnomedSerialiser{
    private static final String LINE_ENDING = " .\n";

    private final Logger LOG = LoggerFactory.getLogger(MetaSnomedSerialiser.class);
    
    private static final String LANGUAGE = "@en-gb";
    
    private final static String NS_SNOMED_BASE = "http://snomedtools.info/ns/snomed/";
