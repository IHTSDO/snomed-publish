...
public class ConceptNotFoundValidationException extends RuleValidationException {
    ...
    public ConceptNotFoundValidationException(RefsetRuleDto ruleDto, ConceptDto conceptDto) {
        super(ruleDto);
        this.conceptDto = conceptDto;
    }

    public ConceptNotFoundValidationException(RefsetRuleDto ruleDto, ConceptDto conceptDto, String message) {
        super(ruleDto, message);
        this.conceptDto = conceptDto;
    }

    public ConceptNotFoundValidationException(RefsetRuleDto ruleDto, ConceptDto conceptDto, Throwable cause) {
        super(ruleDto, cause);
        this.conceptDto = conceptDto;
    }

    public ConceptNotFoundValidationException(RefsetRuleDto ruleDto, ConceptDto conceptDto, String message, Throwable cause) {
