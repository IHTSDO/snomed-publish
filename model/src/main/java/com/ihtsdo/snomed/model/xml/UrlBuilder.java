...
public class UrlBuilder {
    ...
    private static final String ONTOLOGY_ID_KEY = "__ONTOLOGY_ID__";
    ...
    private static final String ONTOLOGY_URL = "http://browser.snomedtools.com/version/" + ONTOLOGY_ID_KEY;
    private static final String CONCEPT_URL = "http://browser.snomedtools.com/version/"+ ONTOLOGY_ID_KEY + "/concept/xml/" + CONCEPT_ID_KEY;
    private static final String STATEMENT_URL = "http://browser.snomedtools.com/version/"+ ONTOLOGY_ID_KEY + "/triple/xml/" + STATEMENT_ID_KEY;
    private static final String DESCRIPTION_URL = "http://browser.snomedtools.com/version/" + ONTOLOGY_ID_KEY + "/description/xml/" + DESCRIPTION_ID_KEY;
        
    
    public static URL createOntologyUrl(Concept c) throws MalformedURLException {
        return new URL(ONTOLOGY_URL.replace(ONTOLOGY_ID_KEY, Long.toString(c.getOntology().getId())));
    }
    
    public static URL createOntologyUrl(Statement s) throws MalformedURLException {
        return new URL(ONTOLOGY_URL.replace(ONTOLOGY_ID_KEY, Long.toString(s.getOntology().getId())));
    }    
    
    public static URL createOntologyUrl(Description d) throws MalformedURLException {
        return new URL(ONTOLOGY_URL.replace(ONTOLOGY_ID_KEY, Long.toString(d.getOntology().getId())));
    }    

    public static URL createDescriptionUrl(Description d) throws MalformedURLException {
        return new URL(DESCRIPTION_URL
                .replace(ONTOLOGY_ID_KEY, Long.toString(d.getOntology().getId()))
    ...
    public static URL createConceptUrl(Concept c) throws MalformedURLException {
        return new URL(CONCEPT_URL
                .replace(ONTOLOGY_ID_KEY, Long.toString(c.getOntology().getId()))
    ...
    public static URL createStatementUrl(Statement s) throws MalformedURLException {
        return new URL(STATEMENT_URL
                .replace(ONTOLOGY_ID_KEY, Long.toString(s.getOntology().getId()))
