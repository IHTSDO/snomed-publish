...
class SerialisedIdDiff implements DiffAlgorithm{
    ...
    public Set<SubjectPredicateObject> getSubjectPredicateObject(final OntologyVersion o, EntityManager em){
        ...
        session.doWork(new Work() {
            public void execute(Connection connection) throws SQLException {
                ...
                while (rs.next()){
                    subjectPredicateObjectSet.add(new SubjectPredicateObject(rs.getLong(1), rs.getLong(2), rs.getLong(3), rs.getLong(4)));
    ...
    private class SubjectPredicateObject {
        ...
        public SubjectPredicateObject(long serialisedId, long subject, long predicate, long object){
        ...
        @Override
        public int hashCode(){
            return Longs.hashCode(serialisedId);
        }
        ...
        public boolean equals(Object o){
            if (o instanceof SubjectPredicateObject){
                ...
                if (s.serialisedId == this.serialisedId){
                    return true;
                }
            }
            return false;
        ...
        public String toString(){
            return "{id:" + serialisedId + ", s:" + subject + ", p:" + predicate + ", o:" + object + ")";
        }
    }
}
