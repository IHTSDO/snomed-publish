...
public interface RefsetPlanService {
    ...
    public abstract RefsetPlan update(RefsetPlanDto updated) throws RefsetPlanNotFoundException, UnReferencedReferenceRuleException, UnconnectedRefsetRuleException, RefsetRuleNotFoundException;

    public abstract RefsetPlan create(RefsetPlanDto created) throws UnReferencedReferenceRuleException, UnconnectedRefsetRuleException, RefsetRuleNotFoundException;
